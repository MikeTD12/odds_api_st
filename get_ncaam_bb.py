...
r = requests.get(
f'{host}/v3/odds/?apiKey={api_key}&sport=basketball_ncaab&region={region}&dateFormat={date_format}&oddsFormat={odds_format}&mkt={mkt}',
    verify=False)
...
if len(bb) > 0:
    ...
    bb.set_index('commence_time')
else:
    bb = "There are no upcoming Men's NCAA Basketball Games."
